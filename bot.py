...
async def main():
    ...
    third_server_url = "https://group-bot-8l89.onrender.com"  # Update to actual address
    fourth_server_url = "https://meme-scraper-nzty.onrender.com"  # Update to actual address
